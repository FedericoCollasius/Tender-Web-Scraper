...
# We will define a function that will take the keywords we are interested in and the number of weeks we want to search for and  find the tenders that match. 
def acumar(keywords, weeks):
...
keywords = []
while True:
    keyword = input("Enter an element (or 'done' to finish): ")
    if keyword == "done":
        break
    keywords.append(keyword)

weeks = int(input("Enter the number of weeks you want to search for: "))

acumar(keywords, weeks)